...
func NewMongoRepository(mongoURL, mongoDB string, mongoTimeout int) (nt.NotificationRepository, error) {
...
func (m *mongoRepository) AddEvent(events *nt.Event) error {
	return nil
}

func (m *mongoRepository) FindEventById(id string) (*nt.Event, error) {
	return nil, nil
}
